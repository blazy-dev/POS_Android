  ...
  const [values, setValues] = useState<ProductFormValues>(() => {
    if (product) {
      return {
        ...
        purchasePrice:
          product.purchase_price > 0 ? product.purchase_price.toString() : '',
    ...
    >
      <View style={styles.section}>
        ...
        <Text style={styles.sectionHint}>
          Escaneá con el lector USB o ingresá el código manualmente. Es
          opcional.
        </Text>
        ...
        {margin !== null ? (
          <View style={styles.marginCard}>
            ...
            <Text
              style={[
                styles.marginValue,
                margin < 0 && styles.marginValueNegative,
              ]}
            >
              {margin.toFixed(1)}%
            </Text>
