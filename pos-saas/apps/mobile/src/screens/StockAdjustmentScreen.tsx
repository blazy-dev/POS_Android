...
export function StockAdjustmentScreen({ product, onBack, onSaved }: StockAdjustmentScreenProps) {
      ...
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.productCard}>
          ...
          <Text style={styles.productBarcode}>
            {product.barcode ? `Código: ${product.barcode}` : "Sin código de barras"}
          </Text>
        ...
        <View style={styles.formSection}>
          ...
          <View style={styles.reasonsRow}>
            {["Ajuste manual", "Rotura/Pérdida", "Compra/Reposición"].map((presetReason) => (
              <Pressable
                key={presetReason}
        ...
        <View style={styles.historySection}>
          ...
          {loadingMovements ? (
            ...
            <Text style={styles.emptyHistoryText}>No hay movimientos registrados para este producto.</Text>
          ) : (
            movements.map((item) => {
              ...
              return (
                <View key={item.id} style={styles.movementRow}>
                  ...
                  <View style={[styles.movementQtyBadge, isIn ? styles.qtyInBadge : styles.qtyOutBadge]}>
                    <Text style={[styles.movementQtyText, isIn ? styles.qtyInText : styles.qtyOutText]}>
                      {isIn ? "+" : "-"}
                      {item.quantity}
                    </Text>
                  </View>
...
const getStyles = (colors: ThemeColors, isDark: boolean) => StyleSheet.create({
  ...
  typeInButton: {
    borderColor: isDark ? "rgba(122, 230, 179, 0.2)" : "rgba(1, 203, 99, 0.2)",
    backgroundColor: isDark ? "rgba(122, 230, 179, 0.04)" : "rgba(1, 203, 99, 0.04)",
  },
  typeOutButton: {
    borderColor: isDark ? "rgba(255, 180, 180, 0.2)" : "rgba(211, 47, 47, 0.2)",
    backgroundColor: isDark ? "rgba(255, 180, 180, 0.04)" : "rgba(211, 47, 47, 0.04)",
  },
  typeInActive: {
    backgroundColor: isDark ? "rgba(122, 230, 179, 0.16)" : "rgba(1, 203, 99, 0.16)",
    borderColor: colors.success,
  },
  typeOutActive: {
    backgroundColor: isDark ? "rgba(255, 180, 180, 0.16)" : "rgba(211, 47, 47, 0.16)",
  ...
  qtyOutBadge: {
    backgroundColor: isDark ? "rgba(255, 180, 180, 0.12)" : "rgba(211, 47, 47, 0.08)",
  },
  movementQtyText: {
    fontSize: 13,
    fontWeight: "800",
