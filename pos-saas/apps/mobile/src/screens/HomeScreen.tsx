...
export function HomeScreen({ onNavigate }: HomeScreenProps) {
  ...
  useEffect(() => {
    ...
    async function loadSummary() {
      ...
      const [nextProductsCount, nextSalesCount, pendingOperations] =
        await Promise.all([
      ...
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.header}>
          <View>
            ...
            <Text style={styles.title}>
              La caja del comercio, en el teléfono.
            </Text>
            <Text style={styles.subtitle}>
              Offline-first, con ventas rápidas, inventario local y
        ...
        <View style={styles.heroCard}>
          ...
          <Text style={styles.heroCopy}>
            Diseñado para lector USB o Bluetooth, con venta local incluso sin
            internet.
          </Text>
        ...
        <View style={styles.footerCard}>
          ...
          <Text style={styles.footerText}>
            Definir navegación base, persistencia SQLite y cola local de
            sincronización.
          </Text>
        </View>
      </ScrollView>
